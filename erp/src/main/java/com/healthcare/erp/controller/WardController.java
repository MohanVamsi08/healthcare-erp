...
public class WardController {
    ...
    public ResponseEntity<Page<WardDTO>> getAll(@PathVariable UUID hospitalId, Pageable pageable) {
        return ResponseEntity.ok(wardService.getByHospital(hospitalId, pageable));
    }
